...
<HTML>
	<HEAD>
		...
		function updeat() {
			...
			var cid = "${cid}";
			$.post("${pageContext.request.contextPath}/adminServlet",{"method":"updateCategory","value":value,"cid":cid},function(data){
				if(data!=null){
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<button type="submit" id="userAction_save_do_submit" value="确定" class="button_ok" onclick="updeat()">
							&#30830;&#23450;
						</button>
