...
<HTML>
	...
	<script type="text/javascript">
		function fun() {
			...
			$.post("${pageContext.request.contextPath}/adminServlet",{"method":"updateProduct","pname":pname,"market_price":market_price,"pimage":pimage,"cid":cid,"pdesc":pdesc,"is_hot":is_hot,"shop_price":shop_price,"pid":pid},function(data){
				if(data!=null){
