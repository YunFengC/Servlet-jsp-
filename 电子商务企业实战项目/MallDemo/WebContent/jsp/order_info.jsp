			...
			<div class="row">
				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							<tr class="warning">
								<th colspan="5">${ordersBean.oid }</th>
							</tr>
							<tr class="warning">
								<th>图片</th>
								<th>商品</th>
							...
							<c:forEach items="${ordersBean.list }" var="list">
							<tr class="active">
								<td width="60" width="40%">
									<input type="hidden" name="id" value="22">
									<img src="${pageContext.request.contextPath}/${list.productbean.pimage}" width="70" height="60">
								</td>
								<td width="30%">
									<a target="_blank"> ${list.productbean.pname}</a>
								</td>
								<td width="20%">
									${list.productbean.market_price}
								</td>
								<td width="10%">
									${list.quantity }
								</td>
