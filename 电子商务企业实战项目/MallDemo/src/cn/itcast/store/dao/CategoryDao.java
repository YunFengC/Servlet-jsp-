...
public interface CategoryDao {
	...
	List findProductDiscard(int startIndex, int pageSize)throws Exception;

	void updatePushDownlist(String pid)throws Exception;

	int Ordercounts()throws Exception;

	List findOrders(int startIndex, int pageSize)throws Exception;
