...
public class OrderDaoImpl implements OrderDao {
	...
	public ordersBean findoid(String oid) throws Exception {
		String sql = "select * from orderitem,product where orderitem.pid=product.pid and oid=?";
	...
	@Override
	public orderitemBean findorderitemoid(String oid) throws Exception {
		String sql = " select * from orderitem where oid=?";
		return runner.query(sql, new BeanHandler<orderitemBean>(orderitemBean.class),oid);
	}

	@Override
	public ProductBean findProductbeanpid(String pid) throws Exception {
