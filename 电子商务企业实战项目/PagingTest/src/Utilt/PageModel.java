...
public class PageModel {
	...
	public String toString() {
		return "PageModel [list=" + list + ", currentPageNum=" + currentPageNum + ", pageSize=" + pageSize
				+ ", totalRecords=" + totalRecords + ", totalPageNum=" + totalPageNum + ", startIndex=" + startIndex
				+ ", prePageNum=" + prePageNum + ", nextPageNum=" + nextPageNum + ", startPage=" + startPage
